...
const _mouseDownEvent = { type: 'mouseDown', mode: null as any }
const _mouseUpEvent = { type: 'mouseUp', mode: null as any }
...
class TransformControls extends Object3D {
  ...
  dispose() {
    ...
    this.traverse(function (child: Mesh<any, Material>) {
...
class TransformControlsGizmo extends Object3D {
  ...
  updateMatrixWorld(force) {
    ...
    console.log(this.mode, this.gizmo)
    ...
    for (let i = 0; i < handles.length; i++) {
      ...
      if ((this.camera as OrthographicCamera).isOrthographicCamera) {
        factor =
          ((this.camera as OrthographicCamera).top - (this.camera as OrthographicCamera).bottom) / this.camera.zoom
      } else {
        factor =
...
class TransformControlsPlane extends Mesh {
  ...
  readonly type = 'TransformControlsPlane'
